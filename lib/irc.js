...
module.exports = class IRC {
  ...
  */
  constructor(oauth, username, debug_mode = false) {
    ...
    let client = Net.connect(6667, 'irc.chat.twitch.tv')
    ...
    client.addListener('data', function(message) {
      if (debug_mode) console.log(message.toString())
      else serverResponse(message)
    })
